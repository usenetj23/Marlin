...
#define STRING_CONFIG_H_AUTHOR "(USENET, SKR-V1.3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKR BMG BLT Linear"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "da41cecf-a909-443a-85d2-d71a90bd705c"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  21.15
    #define DEFAULT_Ki   2.31
    #define DEFAULT_Kd 48.52
  #endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 45.55
  #define DEFAULT_bedKd 760.49
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1280, 1280, 6400, 7020 }
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 840 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 950, 950, 100, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 26.00, -51.25, -1.56 }
...
#define X_MIN_POS -5.60 //-9.40
#define Y_MIN_POS -13.6 //-4.3 //-9.30 
#define Z_MIN_POS 0
...
#define HOMING_FEEDRATE_Z  (4*60) //20*60
